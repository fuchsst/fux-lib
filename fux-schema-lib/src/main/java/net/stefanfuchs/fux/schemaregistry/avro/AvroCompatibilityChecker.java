...
package net.stefanfuchs.fux.schemaregistry.avro;
...
public class AvroCompatibilityChecker {
    ...
    static AvroCompatibilityChecker BACKWARD_CHECKER = new AvroCompatibilityChecker(
            BACKWARD_VALIDATOR);
    ...
    static AvroCompatibilityChecker FORWARD_CHECKER = new AvroCompatibilityChecker(
            FORWARD_VALIDATOR);
    ...
    static AvroCompatibilityChecker FULL_CHECKER = new AvroCompatibilityChecker(
            FULL_VALIDATOR);
    ...
    static AvroCompatibilityChecker BACKWARD_TRANSITIVE_CHECKER = new AvroCompatibilityChecker(
    ...
    static AvroCompatibilityChecker FORWARD_TRANSITIVE_CHECKER = new AvroCompatibilityChecker(
    ...
    static AvroCompatibilityChecker FULL_TRANSITIVE_CHECKER = new AvroCompatibilityChecker(
            FULL_TRANSITIVE_VALIDATOR);

    private static SchemaValidator NO_OP_VALIDATOR = (schema, schemas) -> {
        // do nothing
    };

    static AvroCompatibilityChecker NO_OP_CHECKER = new AvroCompatibilityChecker(
            NO_OP_VALIDATOR);
