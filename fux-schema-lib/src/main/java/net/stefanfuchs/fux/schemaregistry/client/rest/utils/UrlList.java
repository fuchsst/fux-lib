...
package net.stefanfuchs.fux.schemaregistry.client.rest.utils;
 ...
 * and we'll move on to the next url (returning back to the registerSchemasIfAutoRegistrationEnabled if we have to).
 */
