...
package net.stefanfuchs.fux.schemaregistry.client.rest;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.Config;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.ErrorMessage;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.Schema;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.SchemaString;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.requests.CompatibilityCheckResponse;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.requests.ConfigUpdateRequest;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.requests.RegisterSchemaRequest;
import net.stefanfuchs.fux.schemaregistry.client.rest.entities.requests.RegisterSchemaResponse;
import net.stefanfuchs.fux.schemaregistry.client.rest.exceptions.RestClientException;
import net.stefanfuchs.fux.schemaregistry.client.rest.utils.UrlList;
