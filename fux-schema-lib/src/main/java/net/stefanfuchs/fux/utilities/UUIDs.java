 ...
 * (version 1).
 * Copied from com.datastax.driver.core.utils with the following adaptions
 * - Made CLOCK_SEQ_AND_NODE package private
 * - Removed dependency to com.google.common.base.Charsets (used in update method)
...
final class UUIDs {
    ...
    static final long CLOCK_SEQ_AND_NODE = makeClockSeqAndNode();
